...
<h3 class="modal-title">{{LANG.modal.reference.title}}</h3> <a href="#close" title="{{LANG.modal.close}}" class="close" onclick="$('#referenceModal').hide(200)">X</a></div><div class="modal-body">
